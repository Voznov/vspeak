...
export default [
  {
    ignores: ['eslint.config.{js,cjs,mjs}', '**/dist', '.git', '.gitignore', 'tmp', '.tmp', '**/node_modules', '**/*.md', '**/vite.config.ts', '**/public/*.js'],
  },
  ...
  eslintPluginPrettierRecommended,
  {
    ...
    rules: {
      ...
      'import-x/no-extraneous-dependencies': ['error', { peerDependencies: true, devDependencies: true, packageDir: ['./', './server', './web-client'] }],
